...
* **CSS injection:** Removed — the library no longer auto-injects styles. `@grey/editor-ui` emits a standalone `dist/styles.css` that consumers import explicitly. The `grey` React package contains no default CSS.
